const images: any = {
    ...
    logoColor: '/assets/images/logo-color.png',
    firstSectionBG: '/assets/images/first-section-bg.png',
    firstSectionBG2: '/assets/images/first-section-bg22.png',
    ...
    compentence4: '/assets/images/competence4.png',
    compentence5: '/assets/images/competence5.png',
}
